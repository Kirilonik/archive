...
export function Home() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-6">
      ...
      {items.length === 0 && !isLoading && query === '' && selectedGenres.size === 0 ? (
        <div className="card mt-6">
          <div className="text-center py-12">
            ...
            <h2 className="text-2xl font-semibold text-text mb-2">Ваш кинематограф</h2>
            <p className="text-textMuted mb-6 max-w-md mx-auto">
              Здесь вы можете собирать свою коллекцию фильмов и сериалов, отслеживать просмотренное,
              ставить оценки и делиться впечатлениями. Начните с добавления первого фильма или
              сериала!
            </p>
            <button onClick={() => setIsAddModalOpen(true)} className="btn btn-primary px-6 py-3">
