...
process.env.JWT_SECRET = process.env.JWT_SECRET || 'test-jwt-secret-key-min-32-characters-long-for-testing';
process.env.JWT_REFRESH_SECRET = process.env.JWT_REFRESH_SECRET || 'test-jwt-refresh-secret-key-min-32-characters-long-for-testing';
